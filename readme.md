Inlämningsuppgift 1 kurs Javascript klass BCU25D

Admin inlogg: admin@admin.com

Admin måste först logga in via kursdetaljsidan, samma som vanliga användare loggar in på för att boka kurs. Obs endast email..

När admin är inloggad går det att öppna adminsidan för att se bokningar och lägga till kurser.

När man lägger till en kurs anger man bildens namn och sökväg så som den heter i projektet, typ assets/images/blockchain.png

Vanlig användare (ej admin) kan logga in med freddy.kallefjord@medieinstitutet.se för att boka en kurs
...
och webinarier ”On-Demand”. Vi har beslutat att vi behöver en modern och attraktiv plattform att erbjuda våra elever och
...
möjlighet att kunna administrera elever i systemet. Vi vill ha möjlighet att kunna kommunicera 
med elever via e-post och via chatt. Även lärare behöver möjlighet att kunna
kommunicera med elever via e-post och chatt. Elever skall kunna följa sin status i verktyget och även kunna få rekommendationer på nästa steg i sin utveckling. Som till exempel rekommendationer på andra kurser som andra valt
som har gått samma utbildningsspår.För varje kurs så skall det finnas möjlighet för elever att kunna ställa frågor till sin lärare via verktyget.

Bokning av klassrumskurser

För att kunna boka en kurs via verktyget måste man ha ett användarkonto. Så ett sätt för att
...
kurser som är köpta för att kunna rekommendera nya kurser. Detta vill vi skall kunna ske med hjälp av e-postutskick.
...
modernt sätt. oss, där besökare kan få en överblick över vad vi kan erbjuda. Vi vill dessutom
ha en sida där aktuella och populära kurser presenteras.
...
Vid bokning av en kurs så måste användaren/kunden logga in eller skapa ett konto. På
bokningssidan ska följande information anges.
• Kundnamn
• Faktureringsadress
• E-postadress
• Mobilnummer
